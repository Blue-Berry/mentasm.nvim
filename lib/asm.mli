...
val filter_file_direcs : string list -> (Core.Int.t, string) Core.Hashtbl.t * string list
val parse_lines : (int, string) Core.Hashtbl_intf.Hashtbl.t -> string list -> chunk list
val filter_chunks_file : string -> chunk list -> chunk list

type pos = int * int
type pos_map = (pos * int) list

val lines_map_of_chunks : chunk list -> string list * pos_map
